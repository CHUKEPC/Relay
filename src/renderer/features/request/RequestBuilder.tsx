...
import { useScope, useActiveRequest } from '@renderer/lib/hooks'
...
type Tab = 'params' | 'auth' | 'headers' | 'body' | 'scripts'
  ...
  return (
    <div style={{ flex: 'none', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
      ...
      <div style={{ overflowY: 'auto', minHeight: 0 }}>
        ...
        {tab === 'auth' && <AuthTab req={req} />}
        {tab === 'body' && <BodyTab req={req} />}
        {tab === 'scripts' && <ScriptsTab req={req} />}
      </div>
    </div>
  )
}
