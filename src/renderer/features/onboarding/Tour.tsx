...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Потяните заголовок панели к краю окна — она закрепится слева, справа или снизу; отпустите в середине — станет плавающей. Панель ответа переносится так же, за значок-ручку в её строке статуса.'
  },
  {
