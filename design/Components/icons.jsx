/* Icons — clean 1.6px stroke set, 16px grid. window.Icon({name, size}) */
(function () {
  const P = {
  ...
  const FILLED = { send: 1, send2: 1, play: 1, sparkle: 1, bolt: 1, stop: 1 };
  window.Icon = function ({ name, size = 16, className = '', style = {}, strokeWidth }) {
    const d = P[name];
    const filled = FILLED[name];
    return React.createElement('svg', {
      width: size, height: size, viewBox: '0 0 20 20', className, style,
