# Relay — API-клиент для тестирования API

*[English version](README.md)*

Кроссплатформенный десктопный API-клиент для **Windows, macOS и Linux** на **Electron + React +
TypeScript**. Данные хранятся локально в JSON в пользовательском каталоге; секреты шифруются
хранилищем ключей ОС.
